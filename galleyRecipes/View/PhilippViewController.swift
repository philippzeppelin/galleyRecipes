//
//  PhilippViewController.swift
//  galleyRecipes
//
//  Created by Philipp Zeppelin on 02.01.2023.
//


import UIKit

class PhilippViewController: UIViewController {
...
extension PhilippViewController: UITableViewDataSource, UITableViewDelegate {
